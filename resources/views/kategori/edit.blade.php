...
@section('active', 'Kategori / Edit Data')
...
@section('content')
    ...
    <div class="col-lg-14">
        <div class="card">
            ...
            <div class="card-body">
                <div>
                    <h3 class="text-center"><b>EDIT DATA KATEGORI</b></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-14">
        <div class="card">
            <div class="card-body">
                ...
                <div id="pay-invoice">
                    <div class="card-body">
                        <form action="{{ url("kategori/$kategori->id_kategori") }}" method="post" novalidate="novalidate">
                            @method('patch')
                            @csrf
